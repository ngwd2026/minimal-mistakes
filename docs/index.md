  ...
  <div style="padding: 10px 0 20px 0; text-align: left;">
    <div style="margin-bottom: 5px;">
      <a href="https://www.unsw.edu.au/staff/jinhong-yuan" target="_blank" 
         style="text-decoration: none; color: #333; font-weight: bold; font-size: 1.05rem; font-family: 'Open Sans', sans-serif;">
        Prof. Jinhong Yuan (IEEE Fellow)
      </a>
    </div>
    
    <div style="font-size: 0.85rem; color: #444; font-family: 'Open Sans', sans-serif;">
